...
bool json_element::operator==(const json_element &je) const { return  element_equals::compare(*this, je); }
bool json_element::operator!=(const json_element &je) const { return !element_equals::compare(*this, je); }
...
bool json_element::operator< (const json_element &je) const { return  element_less::compare(*this, je); }
bool json_element::operator> (const json_element &je) const { return  element_less::compare(je, *this); }
bool json_element::operator<=(const json_element &je) const { return !element_less::compare(je, *this); }
bool json_element::operator>=(const json_element &je) const { return !element_less::compare(*this, je); }
